...
DEVENV_STATE='/home/osborn/Documents/Github/spatial-tensors/.devenv/profiles/dev/state'
export DEVENV_STATE
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/c17h8sw3ykrkqp99dr4b08whz3mmbxjx-devenv-profile" ]
then
  ln -snf /nix/store/c17h8sw3ykrkqp99dr4b08whz3mmbxjx-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
mkdir -p /run/user/1000/devenv-13e5378
ln -snf /run/user/1000/devenv-13e5378 /home/osborn/Documents/Github/spatial-tensors/.devenv/profiles/dev/run
...
{
  if [[ ":${DIRENV_ACTIVE-}:" == *":/home/osborn/Documents/Github/spatial-tensors:"* ]]; then
...
IN_NIX_SHELL='impure'
export IN_NIX_SHELL
DEVENV_RUNTIME='/run/user/1000/devenv-13e5378'
export DEVENV_RUNTIME
OPTERR='1'
NIX_CFLAGS_COMPILE=' -frandom-seed=b4hsr6gx03 -isystem /nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/include -isystem /nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/include -isystem /nix/store/ai001bwx22qflkig2cxwdqx5bq4kqwmf-proj-9.8.1-dev/include -isystem /nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1/include -isystem /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/include -isystem /nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/include -isystem /nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/include -isystem /nix/store/ai001bwx22qflkig2cxwdqx5bq4kqwmf-proj-9.8.1-dev/include -isystem /nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1/include -isystem /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/include'
export NIX_CFLAGS_COMPILE
NIX_NO_SELF_RPATH='1'
PKG_CONFIG_PATH='/nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/lib/pkgconfig:/nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/lib/pkgconfig:/nix/store/ai001bwx22qflkig2cxwdqx5bq4kqwmf-proj-9.8.1-dev/lib/pkgconfig:/nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1/lib/pkgconfig:/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev/lib/pkgconfig'
...
NIX_LDFLAGS='-rpath /nix/store/b4hsr6gx038qs2i7fcj62nxz556k1dkm-devenv-shell-env/lib  -L/nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/lib -L/nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/lib -L/nix/store/lx1jq37q6pf671w3afd39fgmjkq97awg-proj-9.8.1/lib -L/nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1/lib -L/nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/lib -L/nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/lib -L/nix/store/lx1jq37q6pf671w3afd39fgmjkq97awg-proj-9.8.1/lib -L/nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1/lib'
export NIX_LDFLAGS
declare -a envTargetTargetHooks=()
outputInfo='out'
outputLib='out'
outputMan='out'
XDG_DATA_DIRS='/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0/share:/nix/store/1q851fs62shgjhc03fxxdkpzxdjg7k11-git-cliff-2.13.1/share:/nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/share:/nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/share:/nix/store/lx1jq37q6pf671w3afd39fgmjkq97awg-proj-9.8.1/share:/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9/share:/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2/share:/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2/share'
...
PATH='/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0/bin:/nix/store/1q851fs62shgjhc03fxxdkpzxdjg7k11-git-cliff-2.13.1/bin:/nix/store/mdx9k0rrcrc577qdpkq03l95yyrppbxm-opencommit-3.2.19/bin:/nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env/bin:/nix/store/v6ggik2i697c90ka9g85xvd8sdqz44fk-nixpkgs-fmt-1.3.0/bin:/nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4/bin:/nix/store/lx1jq37q6pf671w3afd39fgmjkq97awg-proj-9.8.1/bin:/nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1/bin:/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9/bin:/nix/store/fcwi1bg401mzdgwxb3vfgnjs7brkd12n-hello/bin:/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2/bin:/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2/bin:/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0/bin:/nix/store/qxaq7jz61a6zkr2mq49i0zvqip2m2jj8-gcc-15.2.0/bin:/nix/store/bsh7n2nx8ndmm1mmww6v2h4851nalj13-glibc-2.42-61-bin/bin:/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin:/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46/bin:/nix/store/s2946bl9ciwzhafd66jhansrmxq9xhqm-binutils-2.46/bin:/nix/store/9ypz3flqsrl5xl495mm8h645gadjsxi1-coreutils-9.11/bin:/nix/store/c1cjgg6p8m8fssivzrc2p13mwwml3p3v-findutils-4.10.0/bin:/nix/store/ww555mznia5v7sz2w85lblg4amvhkhv1-diffutils-3.12/bin:/nix/store/kgxafhycw2kybbqih759ykc2043qyi5j-gnused-4.9/bin:/nix/store/gn94gpcp5q08x4v6g8mvw8v4r65rcjzk-gnugrep-3.12/bin:/nix/store/wp1cshqv98i8abs8rcx91s54igqgll0f-gawk-5.4.0/bin:/nix/store/k5akwnrn9x2afaj2va7g4a2zpdim8l43-gnutar-1.35/bin:/nix/store/ndpbjk6jhw0da5h272dqqnyxa35a9gmx-gzip-1.14/bin:/nix/store/3y3kzc5njlj7nwj1s78am0yzjnpicv9x-bzip2-1.0.8-bin/bin:/nix/store/vlq7nnw39j7rwk0pp68w1fcwzpxahm9h-gnumake-4.4.1/bin:/nix/store/gik3rh1vz2jlgnifb9dh6vc6sxwwz9jj-bash-5.3p9/bin:/nix/store/wgvplwp0faqhqr92w0ma8bxaxk202ama-patch-2.8/bin:/nix/store/csra6zhdjw7rjzv98fycz7qjalyv55k2-xz-5.8.3-bin/bin:/nix/store/kyz3mm5snbb8998kbkm28jps1phk9509-file-5.47/bin'
export PATH
...
buildInputs=''
export buildInputs
out='/nix/store/b4hsr6gx038qs2i7fcj62nxz556k1dkm-devenv-shell-env'
export out
prefix='/nix/store/b4hsr6gx038qs2i7fcj62nxz556k1dkm-devenv-shell-env'
DEVENV_TASKS=''
export DEVENV_TASKS
...
DEVENV_TASK_FILE='/nix/store/aj03aigwv5hrvy6v5fxajbdg67nq099v-tasks.json'
...
strictDeps=''
export strictDeps
nativeBuildInputs='/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0 /nix/store/1q851fs62shgjhc03fxxdkpzxdjg7k11-git-cliff-2.13.1 /nix/store/mdx9k0rrcrc577qdpkq03l95yyrppbxm-opencommit-3.2.19 /nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env /nix/store/v6ggik2i697c90ka9g85xvd8sdqz44fk-nixpkgs-fmt-1.3.0 /nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4 /nix/store/ai001bwx22qflkig2cxwdqx5bq4kqwmf-proj-9.8.1-dev /nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1 /nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev /nix/store/fcwi1bg401mzdgwxb3vfgnjs7brkd12n-hello /nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2'
...
declare -a pkgsBuildHost=('/nix/store/bcnisk3ydfgv26v2gw3zlky24g00yww2-git-2.54.0' '/nix/store/1q851fs62shgjhc03fxxdkpzxdjg7k11-git-cliff-2.13.1' '/nix/store/mdx9k0rrcrc577qdpkq03l95yyrppbxm-opencommit-3.2.19' '/nix/store/n8nwslc7s6bnv8q9qr2yf1ks068z4bzs-python3-3.13.13-env' '/nix/store/v6ggik2i697c90ka9g85xvd8sdqz44fk-nixpkgs-fmt-1.3.0' '/nix/store/w6s19s6cg8pfgzkd1d7gnqfs4ky4jm2c-gdal-3.12.4' '/nix/store/ai001bwx22qflkig2cxwdqx5bq4kqwmf-proj-9.8.1-dev' '/nix/store/lx1jq37q6pf671w3afd39fgmjkq97awg-proj-9.8.1' '/nix/store/iqnjnfnisfb51fdhfi19d8p5i7409v60-geos-3.14.1' '/nix/store/bvsy09r85z0q1m30p87s1bf4ikb0s84i-bash-interactive-5.3p9-dev' '/nix/store/cgjr3kj3hs7ngznyws5qfg16c8scpys0-bash-interactive-5.3p9' '/nix/store/fcwi1bg401mzdgwxb3vfgnjs7brkd12n-hello' '/nix/store/1m05k7xgfnw6jc21xxk5681ni3ar97wf-pkg-config-wrapper-0.29.2' '/nix/store/ilblcn1dkvzghcr2yk3av6jxn5rk1iqw-patchelf-0.15.2' '/nix/store/xknj6c33cc197s60ry0i69vdkmaizrs1-update-autotools-gnu-config-scripts-hook' '/nix/store/0y5xmdb7qfvimjwbq7ibg1xdgkgjwqng-no-broken-symlinks.sh' '/nix/store/cv1d7p48379km6a85h4zp6kr86brh32q-audit-tmpdir.sh' '/nix/store/85clx3b0xkdf58jn161iy80y5223ilbi-compress-man-pages.sh' '/nix/store/p3l1a5y7nllfyrjn2krlwgcc3z0cd3fq-make-symlinks-relative.sh' '/nix/store/5yzw0vhkyszf2d179m0qfkgxmp5wjjx4-move-docs.sh' '/nix/store/fyaryjvghbkpfnsyw97hb3lyb37s1pd6-move-lib64.sh' '/nix/store/kd4xwxjpjxi71jkm6ka0np72if9rm3y0-move-sbin.sh' '/nix/store/pag6l61paj1dc9sv15l7bm5c17xn5kyk-move-systemd-user-units.sh' '/nix/store/cmzya9irvxzlkh7lfy6i82gbp0saxqj3-multiple-outputs.sh' '/nix/store/x8c40nfigps493a07sdr2pm5s9j1cdc0-patch-shebangs.sh' '/nix/store/cickvswrvann041nqxb0rxilc46svw1n-prune-libtool-files.sh' '/nix/store/xyff06pkhki3qy1ls77w10s0v79c9il0-reproducible-builds.sh' '/nix/store/z7k98578dfzi6l3hsvbivzm7hfqlk0zc-set-source-date-epoch-to-latest.sh' '/nix/store/pilsssjjdxvdphlg2h19p0bfx5q0jzkn-strip.sh' '/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0' '/nix/store/mbyy19mdwnfvfwmdi0gqgggx0njvpl1w-binutils-wrapper-2.46' )
NIX_CC='/nix/store/788mx070y81zjlg5ipcl0cra3afviw9k-gcc-wrapper-15.2.0'
export NIX_CC
DEVENV_ROOT='/home/osborn/Documents/Github/spatial-tensors'
export DEVENV_ROOT
UV_SYSTEM_PYTHON='0'
export UV_SYSTEM_PYTHON
DEVENV_DOTFILE='/home/osborn/Documents/Github/spatial-tensors/.devenv/profiles/dev'
...
DEVENV_PROFILE='/nix/store/c17h8sw3ykrkqp99dr4b08whz3mmbxjx-devenv-profile'
...
exec /tmp/devenv-envtDG1GO/script 