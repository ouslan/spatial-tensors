...
This simulated will be generate an outcome variable that it distributes from a normal distributions 
were the data is unfenced spatially by its noughts. This can be summarized with the following model 
...
Were the $\rho$ is the auto regressive component, 
